...
class UserAuthenticate implements IMiddleware {
  ...
  public function handle(Request $request): void {
    ...
    if (!(($userRole === 'user') || ($userRole === 'admin'))) throw new NotAuthorizedHttpException('Недостаточно прав пользователя для доступа');
